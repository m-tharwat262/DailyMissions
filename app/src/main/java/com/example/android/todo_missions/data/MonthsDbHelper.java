...
public class MonthsDbHelper extends SQLiteOpenHelper {


    public static final String LOG_TAG = MonthsDbHelper.class.getSimpleName(); // class name.

    private static final String DATABASE_NAME = "months.db"; // database name.
     ...
     */
    public MonthsDbHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_PETS_TABLE =  "CREATE TABLE " + MonthsEntry.TABLE_NAME + " ("

                + MonthsEntry._ID                                    + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + MonthsEntry.COLUMN_YEAR_ID                         + " INTEGER NOT NULL, "
                + MonthsEntry.COLUMN_MONTH_NAME                      + " TEXT NOT NULL, "
                + MonthsEntry.COLUMN_MONTH_NUMBER                    + " INTEGER NOT NULL, "
                + MonthsEntry.COLUMN_MONTH_DESCRIPTION               + " TEXT, "
                + MonthsEntry.COLUMN_DAYS_NUMBER                     + " INTEGER NOT NULL, "
                + MonthsEntry.COLUMN_ICON_NUMBER                     + " INTEGER NOT NULL, "
                + MonthsEntry.COLUMN_BACKGROUND_ICON_NUMBER          + " INTEGER NOT NULL, "
                + MonthsEntry.COLUMN_BACKGROUND_SMALL_CIRCLE_NUMBER  + " INTEGER NOT NULL, "
                + MonthsEntry.COLUMN_UNIX                            + " INTEGER NOT NULL DEFAULT 0);";
