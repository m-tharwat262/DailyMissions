...
public class TodoProvider extends ContentProvider {
    ...
    private YearDbHelper mYearDbHelper; // get instance of the semester database.
    ...
    public boolean onCreate() {
        ...
        mYearDbHelper = new YearDbHelper(getContext());
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        SQLiteDatabase yearDatabase = mYearDbHelper.getReadableDatabase();
    ...
    private Uri insertYear(Uri uri, ContentValues values) {
        ...
        SQLiteDatabase semesterDatabase = mYearDbHelper.getWritableDatabase();
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        SQLiteDatabase yearsDatabase = mYearDbHelper.getWritableDatabase();
