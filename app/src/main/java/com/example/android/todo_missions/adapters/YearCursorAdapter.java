...
public class YearCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, final Cursor cursor) {
        ...
        int iconIdColumnIndex = cursor.getColumnIndexOrThrow(YearEntry.COLUMN_ICON_NUMBER);
        int iconBackgroundIdColumnIndex = cursor.getColumnIndexOrThrow(YearEntry.COLUMN_BACKGROUND_ICON_NUMBER);
        int smallCircleColumnIndex = cursor.getColumnIndexOrThrow(YearEntry.COLUMN_BACKGROUND_SMALL_CIRCLE_NUMBER);
        int unixNumberColumnIndex = cursor.getColumnIndexOrThrow(YearEntry.COLUMN_UNIX);
        ...
        // get the student name from the database and display it in the screen.
        String yearDate = cursor.getString(yearNumberColumnIndex);
        dateTextView.setText(yearDate);

        // get the student name from the database and display it in the screen.
        int monthsNumber = cursor.getInt(monthsNumberColumnIndex);
        dateDetailsTextView.setText(mContext.getString(R.string.number_of_months, monthsNumber));
